...
class AuthPageLocators:
    ...
    BAD_AUTHORIZATION_LOCATOR = (By.CLASS_NAME, 'formMsg_text')
    RIGHT_AUTHORIZATION_LOCATOR = (By.CLASS_NAME, 'balance-panel')


class MainPageLocators:
    CREATE_FIRST_CAMPAIGN_HREF = (By.XPATH, '//a[contains(text(),"оздайте")]')
    ...
    CREATED_CAMPAIGN_CHECKBOX = '//a[contains(text(),"{}")]/ancestor::div/input'
    ...
    CREATE_FIRST_SEGMENT_HREF = (By.XPATH, '//a[contains(text(),"оздайте")]')
    ...
    CREATED_SEGMENT_DELETE_BUTTON = '//a[contains(text(),"{}")]/ancestor::tr//span[@class="icon-cross"]'
    CREATED_SEGMENT_ID_FIELD = '//a[contains(text(),"{}")]/ancestor::tr//descendant::td[1]/span'
